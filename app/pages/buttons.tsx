...
export default function Buttons() {
  return (
    <section id="buttons" aria-labelledby="buttons-title" className="scroll-mt-28">
      ...
      <div className="space-y-6">
        {variants.map((variant) => (
          <article id={`buttons-${variant}`} key={variant} aria-labelledby={`${variant}-title`} className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
