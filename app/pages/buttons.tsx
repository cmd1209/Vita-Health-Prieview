...
export default function Buttons() {
  return (
    <section id="buttons" aria-labelledby="buttons-title" className="scroll-mt-36">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3 px-5 sm:px-8">
        <div>
      ...
      <div className="space-y-6">
        {variants.map((variant) => (
          <article id={`buttons-${variant}`} key={variant} aria-labelledby={`${variant}-title`} className="scroll-mt-36 overflow-hidden bg-white shadow-sm">
