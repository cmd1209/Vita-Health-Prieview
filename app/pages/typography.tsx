...
export default function Typography() {
  return (
    <section id="typography" aria-labelledby="typography-title" className="mb-12 scroll-mt-28">
        <div className="mb-6">
        ...
        <div className="space-y-6">
          <article id="typography-display" aria-labelledby="type-display-title" className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
          ...
          <article id="typography-quotes" aria-labelledby="type-quotes-title" className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-100 px-6 py-4 sm:px-8">
          ...
          <article id="typography-headings" aria-labelledby="type-headings-title" className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-100 px-6 py-4 sm:px-8">
          ...
          <article id="typography-body" aria-labelledby="type-body-title" className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-100 px-6 py-4 sm:px-8">
          ...
          <article id="typography-labels" aria-labelledby="type-labels-title" className="scroll-mt-28 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-100 px-6 py-4 sm:px-8">
